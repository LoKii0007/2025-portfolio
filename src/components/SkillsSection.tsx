...
const categories = ["All", "Frontend", "Backend", "DevOps", "Languages"];
...
const skills = [
  ...
  { name: "WebSockets", category: "Backend", icon: "📡" },
    ...
    >
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-10 md:mb-16 space-y-3 md:space-y-4">
          ...
          >
            MERN & PERN stack technologies I use to build production-ready,
            real-time, and performance-sensitive web applications.
          </motion.p>
        </div>
